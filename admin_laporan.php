...
<body>
    <nav>
        <div class="nav-container">
            <a href="admin_index.php" class="brand"><i class="fas fa-store"></i> Admin Panel</a>
            <div>
                ...
                <a href="admin_laporan.php" class="active"><i class="fas fa-file-alt"></i> Laporan</a>
    ...
    <div class="container">
        <div class="header-section" style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px;">
            ...
            <a href="admin_index.php" class="button" style="background: #95a5a6;">Kembali</a>
        </div>
